...
export const strategyTemplates: Strategy[] = [
    {
        ...
        description: 'Double your stake after each loss to recover losses with a single win',
        author: 'FxProTrades',
        category: 'martingale',
        difficulty: 'beginner',
        profitability: 72,
    ...
    },
    {
        ...
        description: 'Trade in the direction of the market trend using moving averages',
        author: 'FxProTrades',
        category: 'trend',
    ...
    },
    {
        ...
        description: 'Increase stake after wins, reduce after losses - safer approach',
        author: 'FxProTrades',
        category: 'martingale',
        difficulty: 'beginner',
        profitability: 64,
