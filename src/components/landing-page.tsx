        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-black via-gray-900 to-black relative overflow-hidden">
                ...
                <div className="text-center space-y-6">
                    ...
                    <div className="pt-6 border-t border-border">
                        <p className="text-xs text-muted-foreground">
                            Powered by <span className="text-yellow-500 font-semibold">Deriv</span>
                        </p>
                        <button
            ...
            <Dialog open={showWelcomeDialog} onOpenChange={setShowWelcomeDialog}>
                <DialogContent className="bg-card border-yellow-500/20">
                    <DialogHeader>
                        <DialogTitle className="text-2xl text-yellow-500">Welcome to FxProTrades!</DialogTitle>
                    </DialogHeader>
                    <div className="space-y-4 text-sm">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-muted-foreground">Deriv Bot - your automated trading partner</p>
                        </div>
                        ...
                        <div className="bg-destructive/10 border border-destructive/30 rounded-lg p-4 text-xs">
                            ...
                            <p className="text-muted-foreground">
                                Deriv offers complex products, including options and CFDs, which carry significant risks.
                                Trading CFDs involves leverage, which can amplify both profits and losses, potentially
                                leading to the loss of your entire investment. Trade only with money you can afford to
                                lose and never borrow to trade. Understand the risks before trading.
                            </p>
                        </div>
                    </div>
                </DialogContent>
