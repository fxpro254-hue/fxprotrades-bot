      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="p-6 border-yellow-500/20">
          <div className="flex items-center justify-between">
            ...
            <svg
              className="w-12 h-12 text-yellow-500/30"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
        ...
        <Card className="p-6 border-green-500/20">
          <div className="flex items-center justify-between">
            ...
            <svg
              className="w-12 h-12 text-green-500/30"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
        ...
        <Card className="p-6 border-yellow-500/20">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p
                className={`text-3xl font-bold ${stats.totalProfit >= 0 ? "text-green-500" : "text-red-500"}`}
              >
        ...
        <Card className="p-6 border-yellow-500/20">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p
                className={`text-3xl font-bold ${stats.avgProfit >= 0 ? "text-green-500" : "text-red-500"}`}
              >
        ...
        <Card className="p-6 border-yellow-500/30 bg-yellow-500/5">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div>
              ...
              <p className="font-medium text-red-500 inline">
            ...
            <div>
              ...
              <p
                className={`font-medium ${currentSession.totalProfit >= 0 ? "text-green-500" : "text-red-500"}`}
              >
